...
<body>
    ...
    <section class="header-site">
        <div class="linha linhaUser">
            <div class="contentLine"> <a style="text-align: Left"><strong>Voltar</strong></a> <a style="text-align: center"><strong>Estoque!</strong></a> <?php if(isset($_SESSION['email'])){ $nome = new DAOCadastroGeral(); $nome->Email = $_SESSION['email']; echo "Bem-Vindo ".$nome->readName(); } else { echo "Funcionario Atual"; } ?> <a class="logOutbtn" onclick="modalShowOut()">Log out</a></div>
        </div>
    </section>
