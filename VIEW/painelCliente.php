...
<body>
    ...
    <section class="header-site">
        <div class="linha linhaUser">
            <div class="contentLine"> <?php $nome = new DAOCadastroGeral(); $nome->Email = $_SESSION['email']; echo "Bem-Vindo ".$nome->readName(); ?> <a class="logOutbtn" onclick="modalShowOut()">Log out</a></div>
        </div>
    </section>
    <section class="content-site">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12"> <?php IMPlistaCompras($_SESSION['email'],"../MODEL/PHP files/DAOMovimento_Geral.php","../MODEL/PHP files/DAOProdutos.php"); ?> </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="thumbnail"> <img src="_img/img-04.jpg">
                        <div class="caption text-center"> </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="thumbnail"> <img src="_img/img-05.jpg">
                        <div class="caption text-center"> </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="thumbnail"> <img src="_img/img-06.jpg">
                        <div class="caption text-center"> </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-modal-logout">
        <div class="modal-content">
            ...
            <form>
                <p class="text-center">Deseja Sair de Sua Seção?</p> <a href="../CONTROLLER/Outros/Logout.php" class="btn btn-danger">Sim</a> <a href="" class="btn btn-dark" onclick="modalCloseOut()">Cancelar</a>
            </form>
        </div>
    </div>
</body>
