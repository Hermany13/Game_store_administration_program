    ...
    <section class="header-site">
        <div class="linha linhaUser">
            <div class="contentLine">
                <div style="text-align: left">Painel de <strong>Gerente</strong></div> <a class="logOutbtn" onclick="modalShowOut()">Log out</a>
            </div>
        </div> <?php $nome = new DAOCadastroGeral(); $nome->Email = $_SESSION['email']; echo "Bem-Vindo ".$nome->readName(); ?>
    </section>
