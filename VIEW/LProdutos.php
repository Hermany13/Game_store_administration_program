<?php require_once("../CONTROLLER/Outros/cons_quant_prod.php");
session_start();
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    ...
    <section class="header-site">
        <div class="linha linhaUser">
            <div class="contentLine"> imprmir nome do nego aqui <a class="logOutbtn" onclick="modalShowOut()">Log out</a></div>
        </div>
    </section>
    <section class="content-site2">
        ...
        <div class="teste">
            ...
            <div id="top" class="row">
                ...
                <div class="col-md-6">
                    <div class="input-group h2"> <input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar Itens no Estoque"> <span class="input-group-btn"> <button class="btn btn-primary" type="submit"> <span class="glyphicon glyphicon-search"></span> </button> </span> </div>
                </div>
                <div class="col-md-3"> <a class="btn btn-primary pull-right h2" <?php if($_SESSION['ni_user'] != 2 ){ echo " style=\"color:black; cursor: not-allowed; opacity: 0.5; ";} else {echo "href=\"cadastroProduto.html\"";}?>">Novo Item</a> </div>
            </div>
            ...
            <div class="bg-modal-logout">
                <div class="modal-content">
                    ...
                    <form>
                        <p>Deseja Sair de Sua Seção?</p> <a href="../CONTROLLER/Outros/Logout.php" class="btn btn-danger">Sim</a> <a href="" class="btn btn-danger" onclick="modalCloseOut()">Não</a>
                    </form>
                </div>
            </div>
        </div>
