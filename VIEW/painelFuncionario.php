...
<!--        Um Model para cada!-->
    <div class="bg-modal">
        ...
        <div class="modal-content">
            ...
            <form>
                <input class="inputModal" type="text" name="valorAbrir" placeholder="Digite um Valor"/>
                <a href="telaCaixa.php" class="btn btn-dark">Continuar</a>
            </form>
        </div> 
    </div>
        ...
        <div class="modal-content">
            ...
            <form>
                <input class="inputModal" type="text" name="valorFechar" placeholder="Digite um Valor"/>
                <a href="telaCaixa.php" class="btn btn-dark">Continuar</a>
            </form>
        </div> 
    </div>
